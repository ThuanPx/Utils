...
package com.thuanpx.androidinapppurchase.billing
...
import com.thuanpx.utils.billing.BillingConstant
import com.thuanpx.utils.billing.SingleLiveEvent
...
class BillingClientLifecycle private constructor(
    ...
    val purchaseSuccess = SingleLiveEvent<List<Purchase>>()
    val purchaseError = SingleLiveEvent<String>()
    ...
    fun querySkuDetails() {
        ...
        val params = SkuDetailsParams.newBuilder()
            ...
            .setSkusList(BillingConstant.listSku)
            .build()
    ...
    override fun onPurchasesUpdated(
        ...
        when (responseCode) {
            BillingClient.BillingResponseCode.OK -> {
                ...
                purchaseSuccess.postValue(purchases)
            }
            BillingClient.BillingResponseCode.USER_CANCELED -> {
                Log.i(TAG, "onPurchasesUpdated: User canceled the purchase")
                purchaseError.postValue("User canceled the purchase")
            }
            BillingClient.BillingResponseCode.ITEM_ALREADY_OWNED -> {
                Log.i(TAG, "onPurchasesUpdated: The user already owns this item")
                purchaseError.postValue("The user already owns this item")
            }
            BillingClient.BillingResponseCode.DEVELOPER_ERROR -> {
                Log.e(
            ...
            else -> purchaseError.postValue("Error Purchase")
        }
    }
    ...
    private fun logAcknowledgementStatus(purchasesList: List<Purchase>) {
        ...
        for (purchase in purchasesList) {
            ...
            Log.d(TAG, "sku=${purchase.sku} token:${purchase.purchaseToken}")
    ...
    fun consumePurchase(token: String) {
        ...
        billingClient.consumeAsync(
            ...
            val responseCode = billingResult.responseCode
            val debugMessage = billingResult.debugMessage
            Log.d(TAG, "consumePurchase: $responseCode $debugMessage")
            Log.d(TAG, "consumePurchase text: $s")
        }
    }
}
